...
<body>
   ...
   <li>
    ...
    <div class="form-group">
        ...
        <input type="date" name="task_due_date" class="form-control" value="{{ old('task_due_date', $task->task_due_date) }}" required>
    </div>
    ...
    {{-- <div class="form-group">
        <label>Status</label>
        <select style="height:10% "name="task_status" class="form-control" required>
            <option value="">Select</option>
            <option value="pending" {{ old('task_status', $task->task_status) == 'pending' ? 'selected' : '' }}>Pending</option>
            <option value="process" {{ old('task_status', $task->task_status) == 'process' ? 'selected' : '' }}>Process</option>
    ...
    <div class="form-group">
        ...
        <select style="height:10% "name="task_assigned_to" class="form-control" required>
            ...
            @foreach ($users as $user)
                <option value="{{ $user->id }}" {{ old('task_assigned_to', $task->task_assigned_to) == $user->id ? 'selected' : '' }}>
                    {{ $user->user_name }}
                </option>
            @endforeach
        </select>
